...
fn main() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::list_inodes_tree,
            commands::upload_inodes_tree,
            commands::create_folder_inode_tree,
            commands::delete_inode_tree,
            commands::move_inode_tree,
            commands::rename_inode_tree,
            commands::download_file_tree,
